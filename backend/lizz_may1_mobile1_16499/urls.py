"""lizz_may1_mobile1_16499 URL Configuration
...
admin.site.site_header = "lizz may1 mobile1"
admin.site.site_title = "lizz may1 mobile1 Admin Portal"
admin.site.index_title = "lizz may1 mobile1 Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="lizz may1 mobile1 API",
        default_version="v1",
        description="API documentation for lizz may1 mobile1 App",
    ),
    public=True,
